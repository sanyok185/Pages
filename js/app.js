(() => {
    ...
    window.onscroll = function() {
        ...
        if (document.body.scrollTop > 1e3 || document.documentElement.scrollTop > 1e3) button.style.visibility = "visible"; else button.style.visibility = "hidden";
    };
